...
ref_and_query_samples <- c("tumor_primary")
...
seurat_object = subset(seurat_object, subset = disease %in% cancer_samples)
...
seurat_object$disease_grouped_qr[seurat_object$origin == "tumor_primary" & seurat_object$disease == "lung adenocarcinoma" & seurat_object$uicc_stage == "I"] <- "reference_samples"
